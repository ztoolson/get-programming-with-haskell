...
data ThreeLetterAlphabet = Alpha | Beta | Kappa deriving (Show, Enum, Bounded, Eq)
...
-- a rotNdecoder that works with odd number alphabets
...
-- a working 3 letter decoder. need to use this for odd length alphabets
threeLetterDecoder :: [ThreeLetterAlphabet] -> [ThreeLetterAlphabet]
threeLetterDecoder vals = map rot3l vals
    where alphaSize = 1 + fromEnum (maxBound :: ThreeLetterAlphabet)
          rot3l = rotNdecoder alphaSize

-- Rotating strings with rotEncoder and rotDecoder
